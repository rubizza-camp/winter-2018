...
class IngestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingestion" do
    assert_difference('Ingestion.count') do
      post ingestions_url, params: { ingestion: { dish_id: @ingestion.dish_id, user_id: @ingestion.user_id } }
    end
  ...
  test "should update ingestion" do
    patch ingestion_url(@ingestion), params: { ingestion: { dish_id: @ingestion.dish_id, user_id: @ingestion.user_id } }
